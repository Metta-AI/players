...
from cogames_agents.policy.scripted_agent.common.goal import Goal
from cogames_agents.policy.scripted_agent.common.goal import evaluate_goals as _evaluate_goals
