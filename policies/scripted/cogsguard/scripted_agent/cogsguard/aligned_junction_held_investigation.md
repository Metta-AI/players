...
- `policies/scripted/cogsguard/nim_agents/cogsguard_agents.nim` - Nim scripted agents
- `policies/scripted/cogsguard/scripted_agent/cogsguard/` - Python scripted agents
