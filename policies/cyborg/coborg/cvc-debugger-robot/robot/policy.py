...
from robot.types import Coord, MacroCommand, NavState
from robot.perception import parse_observation
from robot.memory import SpatialMemory, SelfState, GameClock
from robot.pathfinding import Navigator
from robot.state import build_snapshot
from robot.brain import RobotBrain, EXPLORE_PHASE_END
from robot.blackbox import BlackBox
from robot.roster import DraftBoard, TeammateMemory, DRAFT_DEADLINE
from robot.observability import (
  ObservabilityHub, start_server, get_hub, is_debug_enabled, build_tick_payload,
)
from robot.llm_coordinator import LLMCoordinator
...
class RobotAgent(AgentPolicy):
  ...
  def step(self, obs: AgentObservation) -> Action:
    ...
    from robot.perception import extract_local_position
