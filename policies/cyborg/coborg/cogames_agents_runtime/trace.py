...
class LoggingTraceSink:
    ...
    def __init__(self, logger: logging.Logger | None = None, *, level: int = logging.INFO) -> None:
        self.logger = logger if logger is not None else logging.getLogger("cogames_agents.cyborg")
        self.level = level
...
class LoggingMetricsSink:
    ...
    def __init__(self, logger: logging.Logger | None = None, *, level: int = logging.INFO) -> None:
        self.logger = logger if logger is not None else logging.getLogger("cogames_agents.cyborg.metrics")
        self.level = level
