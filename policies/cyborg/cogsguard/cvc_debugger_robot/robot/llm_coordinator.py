...
Usage:
  Activated by passing llm_model to RobotPolicy:
    class=policies.cyborg.cogsguard.cvc_debugger_robot.robot.RobotPolicy,kw.llm_model=anthropic/claude-opus-4.6
"""
...
from policies.cyborg.cogsguard.cvc_debugger_robot.robot.types import Coord, manhattan
