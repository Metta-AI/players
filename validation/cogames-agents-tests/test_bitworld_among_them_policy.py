...
import numpy as np
import pytest
from cogames_agents.policy import bitworld_among_them as among_them
from cogames_agents.policy.bitworld_among_them import (
...
def test_bitworld_among_them_scout_short_name_resolves() -> None:
    assert (
        ...
        == "cogames_agents.policy.bitworld_among_them.BitWorldAmongThemScoutPolicy"
    )
...
def test_bitworld_among_them_cyborg_short_name_resolves() -> None:
    assert (
        ...
        == "cogames_agents.policy.bitworld_among_them.BitWorldAmongThemCyborgPolicy"
    )
...
def test_bitworld_among_them_signal_runner_short_name_resolves() -> None:
    assert (
        ...
        == "cogames_agents.policy.bitworld_among_them.BitWorldAmongThemSignalRunnerPolicy"
    )
...
def test_bitworld_among_them_beacon_short_name_resolves() -> None:
    assert (
        ...
        == "cogames_agents.policy.bitworld_among_them.BitWorldAmongThemBeaconPolicy"
    )
...
def test_bitworld_among_them_task_marshal_short_name_resolves() -> None:
    assert (
        ...
        == "cogames_agents.policy.bitworld_among_them.BitWorldAmongThemTaskMarshalPolicy"
    )
...
def test_bitworld_among_them_nottoodumb_short_name_resolves() -> None:
    ...
    assert (
        ...
        == "cogames_agents.policy.bitworld_among_them.BitWorldAmongThemNotTooDumbPolicy"
    )
...
def test_bitworld_among_them_variant_short_names_resolve() -> None:
    ...
    for policy_class in policy_classes:
        assert (
            ...
            == f"cogames_agents.policy.bitworld_among_them.{policy_class.__name__}"
        )
...
def test_bitworld_among_them_circuit_sentinel_short_name_resolves() -> None:
    assert (
        ...
        == "cogames_agents.policy.bitworld_among_them.BitWorldAmongThemCircuitSentinelPolicy"
    )
