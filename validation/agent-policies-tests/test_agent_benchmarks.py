...
import pytest
from agent_policies.policies.scripted.cogsguard.scripted_registry import (
...
_POLICY_CLASS_MAP: dict[str, tuple[str, str]] = {
    "baseline": (
        "agent_policies.policies.scripted.cogsguard.scripted_agent.baseline_agent",
        "BaselinePolicy",
    ),
    "tiny_baseline": (
        "agent_policies.policies.scripted.cogsguard.scripted_agent.demo_policy",
        "DemoPolicy",
    ),
}
...
class TestEvolutionModuleImportable:
    ...
    def test_import_evolution(self) -> None:
        from agent_policies.policies.scripted.cogsguard.evolution.cogsguard.evolution import (  # noqa: PLC0415
            RoleCatalog,
            RoleDef,
            sample_role,
        )
    ...
    def test_import_coordinator(self) -> None:
        from agent_policies.policies.scripted.cogsguard.evolution.cogsguard.evolutionary_coordinator import (  # noqa: PLC0415
