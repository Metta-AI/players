...
Both use `agent_policies.frameworks.cyborg_evolution.base_evolution`:
...
`src/agent_policies/frameworks/cyborg_evolution/wiki/strategy/promoted-patterns.md`.
...
| File | Purpose |
|---|---|
| `src/agent_policies/frameworks/cyborg_evolution/base_evolution.py` | str_replace executor, git workflow, cross-game memory |
