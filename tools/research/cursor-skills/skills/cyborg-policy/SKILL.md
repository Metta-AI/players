...
Subclass `agent_policies.frameworks.cyborg_evolution.base_policy.BasePolicy`:

```python
from agent_policies.frameworks.cyborg_evolution.base_policy import BasePolicy
from agent_policies.frameworks.cyborg_evolution.base_brain import BaseBrain
from agent_policies.frameworks.cyborg_evolution.base_harness import BaseHarness
from agent_policies.frameworks.cyborg_evolution.types import Command, GameConfig
...
- `src/agent_policies/frameworks/cyborg_evolution/wiki/skills/frame-parsing.md` — observation → snapshot patterns
- `src/agent_policies/frameworks/cyborg_evolution/wiki/skills/movement.md` — pathfinding in execute()
