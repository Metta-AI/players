...
Subclass `agent_policies.frameworks.cyborg_evolution.base_brain.BaseBrain`
and implement four methods:

```python
from agent_policies.frameworks.cyborg_evolution.base_brain import BaseBrain
from agent_policies.frameworks.cyborg_evolution.types import Command, CommandKind, Directive, GameConfig
...
- `src/agent_policies/frameworks/cyborg_evolution/wiki/skills/role-selection.md` — role switching patterns
- `src/agent_policies/frameworks/cyborg_evolution/wiki/skills/movement.md` — pathfinding and navigation
- `src/agent_policies/frameworks/cyborg_evolution/wiki/strategy/opening.md` — early-game decision structure
