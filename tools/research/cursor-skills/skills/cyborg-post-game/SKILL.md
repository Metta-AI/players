...
def _run_post_game_background(self, dump, filepath, trigger):
    from agent_policies.frameworks.cyborg_evolution.base_analysis import run_post_game_analysis
...
python -c "
from agent_policies.frameworks.cyborg_evolution.base_analysis import run_post_game_analysis
from agent_policies.frameworks.cyborg_evolution.providers import create_analysis_provider
import json
...
`agent_policies.frameworks.cyborg_evolution.base_evolution.accumulate_cross_game_memory()`
tracks patterns
...
| File | Purpose |
|---|---|
| `src/agent_policies/frameworks/cyborg_evolution/base_analysis.py` | Analysis runner, prompt builder, synthesis |
| `src/agent_policies/frameworks/cyborg_evolution/score_tracker.py` | Score history, rolling avg, escalation |
