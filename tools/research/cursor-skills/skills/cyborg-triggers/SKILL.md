...
Subclass `agent_policies.frameworks.cyborg_evolution.base_triggers.BaseEventDetector`:

```python
from agent_policies.frameworks.cyborg_evolution.base_memory import GameMemory, GameEvent
from agent_policies.frameworks.cyborg_evolution.base_triggers import BaseEventDetector
...
- `src/agent_policies/frameworks/cyborg_evolution/wiki/mechanics/trigger-system.md` — full trigger architecture
- `src/agent_policies/frameworks/cyborg_evolution/wiki/skills/llm-integration.md` — when/how to consult the LLM
