...
### Framework Wiki (`src/agent_policies/frameworks/cyborg_evolution/wiki/`)
...
- `src/agent_policies/frameworks/cyborg_evolution/wiki/strategy/promoted-patterns.md` — patterns promoted from games
- `src/agent_policies/frameworks/cyborg_evolution/wiki/strategy/common-mistakes.md` — universal failure patterns
