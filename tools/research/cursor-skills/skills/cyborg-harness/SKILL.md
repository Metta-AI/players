...
Subclass `agent_policies.frameworks.cyborg_evolution.base_harness.BaseHarness`
and implement four methods:

```python
from agent_policies.frameworks.cyborg_evolution.base_harness import BaseHarness
from agent_policies.frameworks.cyborg_evolution.base_memory import GameMemory
from agent_policies.frameworks.cyborg_evolution.types import Directive
...
- `src/agent_policies/frameworks/cyborg_evolution/wiki/skills/llm-integration.md` — consultation model, token budgets
- `src/agent_policies/frameworks/cyborg_evolution/wiki/skills/memory-management.md` — what to include from each tier
- `src/agent_policies/frameworks/cyborg_evolution/wiki/mechanics/memory-tiers.md` — memory tier technical reference
