...
The framework wiki (wiki/) provides universal skills and
...
from agent_policies.frameworks.cyborg_evolution.base_evolution import GameEvolutionConfig

EDITABLE_FILES = [
  # Decision logic — the main evolution target
  "games/new_game/brain.py",
  # Game-specific wiki — evolves alongside the brain
  "games/new_game/wiki/strategy/opening.md",
  "games/new_game/wiki/strategy/common-mistakes.md",
  # Add more editable files as your game grows:
  # "games/new_game/triggers.py",
  # "games/new_game/wiki/skills/your_skill.md",
]
...
4. Refer to wiki/ for universal patterns (memory, triggers, etc.)
...
GAME_EVOLUTION_CONFIG = GameEvolutionConfig(
  ...
  policy_dir_glob="games/new_game/",
)
