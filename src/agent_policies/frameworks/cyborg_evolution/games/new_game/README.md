...
- `wiki/skills/frame-parsing.md` — how to parse observations into snapshots
- `wiki/skills/movement.md` — pathfinding, exploration, stuck detection
- `wiki/skills/memory-management.md` — three-tier memory system
- `wiki/skills/llm-integration.md` — when/how to consult the LLM
- `wiki/skills/role-selection.md` — role switching patterns

Universal strategy:
- `wiki/strategy/opening.md` — first 10-20% of any game
- `wiki/strategy/resource-management.md` — acquire/store/convert/deploy
- `wiki/strategy/adaptation.md` — mid-game strategy shifts
- `wiki/strategy/common-mistakes.md` — failure patterns to avoid
- `wiki/strategy/promoted-patterns.md` — proven patterns from other games

Mechanics reference:
- `wiki/mechanics/evolution-loop.md` — the self-improvement pipeline
- `wiki/mechanics/trigger-system.md` — event detection and LLM scheduling
- `wiki/mechanics/memory-tiers.md` — working/episodic/strategic memory
