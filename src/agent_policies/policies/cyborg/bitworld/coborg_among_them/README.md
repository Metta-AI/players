...
The sibling package
[`agent_policies.policies.cyborg.bitworld.among_them`](../among_them/__init__.py)
...
docker build -t coborg_among_them:dev \
  -f ~/coding/agent-policies/src/agent_policies/policies/cyborg/bitworld/coborg_among_them/coworld/Dockerfile \
