...
from agent_policies.policies.cyborg.cogsguard.cvc_debugger_robot.robot.types import Coord, MacroCommand, NavState
from agent_policies.policies.cyborg.cogsguard.cvc_debugger_robot.robot.perception import parse_observation
from agent_policies.policies.cyborg.cogsguard.cvc_debugger_robot.robot.memory import SpatialMemory, SelfState, GameClock
from agent_policies.policies.cyborg.cogsguard.cvc_debugger_robot.robot.pathfinding import Navigator
from agent_policies.policies.cyborg.cogsguard.cvc_debugger_robot.robot.state import build_snapshot
from agent_policies.policies.cyborg.cogsguard.cvc_debugger_robot.robot.brain import RobotBrain, EXPLORE_PHASE_END
from agent_policies.policies.cyborg.cogsguard.cvc_debugger_robot.robot.blackbox import BlackBox
from agent_policies.policies.cyborg.cogsguard.cvc_debugger_robot.robot.roster import DraftBoard, TeammateMemory, DRAFT_DEADLINE
...
class RobotAgent(AgentPolicy):
  ...
  def step(self, obs: AgentObservation) -> Action:
    ...
    from agent_policies.policies.cyborg.cogsguard.cvc_debugger_robot.robot.perception import extract_local_position
