...
`agent_policies.policies.scripted.cogsguard.scripted_agent`.
...
```python
from agent_policies.policies.scripted.cogsguard.scripted_agent.baseline_agent import BaselinePolicy
...
```python
from agent_policies.policies.scripted.cogsguard.scripted_agent.unclipping_agent import UnclippingPolicy
...
```python
from agent_policies.policies.scripted.cogsguard.scripted_agent.my_agent import MyPolicy
