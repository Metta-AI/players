...
- `src/agent_policies/policies/scripted/cogsguard/nim_agents/cogsguard_agents.nim` - Nim scripted agents
- `src/agent_policies/policies/scripted/cogsguard/scripted_agent/cogsguard/` - Python scripted agents
