...
import agent_policies.policies.scripted.cogsguard.nim_agents.agents as na
...
# Agent to evaluate
AGENT_PATH = "agent_policies.policies.scripted.cogsguard.nim_agents.agents.ThinkyAgentsMultiPolicy"
