...
def decide(context: dict[str, Any]) -> dict[str, Any]:
    ...
    if use_bedrock:
        ...
        model = os.environ.get("RICHARDNOTSUS_LLM_MODEL") or os.environ.get(
        ...
        model = os.environ.get("RICHARDNOTSUS_LLM_MODEL", DEFAULT_DIRECT_MODEL)
...
def _enabled() -> bool:
    return (
        _flag("RICHARDNOTSUS_LLM_MEETINGS")
...
def _system_prompt() -> str:
    path = os.environ.get("RICHARDNOTSUS_LLM_SYSTEM_PROMPT_PATH")
    if path:
