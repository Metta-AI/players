...
Byte-level decoding lives in :mod:`players.crewrift.richardborg.perception.decoder`;
...
from players.crewrift.richardborg.perception.decoder import apply_message
