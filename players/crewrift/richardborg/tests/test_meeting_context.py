...
from players.crewrift.richardborg.types import Belief, ChatEvent, PlayerRecord


def _belief() -> Belief:
    belief = Belief(
        phase="Voting", phase_start_tick=10, last_tick=34, total_player_count=3
    )
    ...
    belief.roster["green"] = PlayerRecord(
        color="green", life_status="dead", death_seen_tick=30
    )
