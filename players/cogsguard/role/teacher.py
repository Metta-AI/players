...
from players.cogsguard.nim.agents import CogsguardAgentsMultiPolicy
from players.cogsguard.role.types import Role as CogsguardRole
from players.cogsguard._shared.common.roles import ROLE_VIBES
