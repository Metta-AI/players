#!/usr/bin/env bash
# Build the CogsGuard tiny_baseline player image and emit Coworld manifest
...
PLAYER_ID="cogsguard-tiny-baseline"
PLAYER_NAME="CogsGuard Tiny Baseline"
PLAYER_DESCRIPTION="Compact demo policy for the cogs_vs_clips Coworld; minimal heart-recipe scout."
PLAYER_GAMES_JSON='["cogs_vs_clips"]'
PLAYER_AUTHOR="players@softmax.com"
IMAGE_LOCAL_TAG="players-cogsguard-tiny-baseline:dev"
