...
| 2026-05-21 | `jamesboggs-guided-bot-coworld-20260519-094820:v5` | Among Them Daily (`league_494db37d-d046-4cba-a99a-536b1439262f`) | linux/amd64 image uploaded without `--use-bedrock`; submission `sub_38f0d3f5-e5b2-4936-9749-5705e0986305` accepted with policy version `68b09089-8530-419b-b3d2-34d7607ca064` and remained `pending` with no membership row when logged. This version keeps the v4 post-task crew behavior and changes the crewmate body-report reflex from body-count edge detection to remembered-position unknown-body detection, so a different visible corpse can trigger reporting even when the visible body count stays stable. |
